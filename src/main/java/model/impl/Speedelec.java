...
public class Speedelec  extends AbstractElectricBike {
    ...
    public Speedelec(BasicTypeEnum basicType, ProductTypeEnum productType,
                     String brand, int weightOfTheBike, boolean isLigths, String color, int price, int maxSpeed, int batteryCapacity) {
